class Poll {
    constructor(root, title) {
        ...
        this.endpoint = "http://192.168.0.3:3000/poll";
            ...
            template.innerHTML = `
                <div class="poll__option ${ this.selected == option.label ? "poll__option--selected": "" }">
                    ...
                    <div class="poll__option-info">
                        ...
                        <span class="poll__percentage">${ option.percentage } votes</span>
                    </div>
                </div>
            `;
...
const p = new Poll(
    ...
    "<div class='poll-title'><img src='./images/luffy-gear-5-colored.png' class='luffy'/><p>Vote for your favourate candidate.</p></div>",
